...
In other words, if you have a string and you think it might have been generated by a given (suitably simple) Bracery program,
then you can reconstruct _how_ that program generated that output.
