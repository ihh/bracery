...
var testProps = {"JAVASCRIPT_FILE":"/api/v1/asset/bracery-view.js","STYLE_FILE":"/api/v1/asset/bracery-view.css","APP_JAVASCRIPT_FILE":"/api/v1/asset/app.js","APP_STYLE_FILE":"/api/v1/asset/app.css","BASE_URL":"https://bracery.org","STORE_PATH_PREFIX":"/api/v1/store/","VIEW_PATH_PREFIX":"/","BOOKMARK_PATH_PREFIX":"/api/v1/bookmark/","EXPAND_PATH_PREFIX":"/api/v1/expand/","LOGIN_PATH_PREFIX":"/api/v1/login/","TWITTER_PATH_PREFIX":"/api/v1/twitter/","SOURCE_CONTROLS_STYLE":"style=\"display:none;\"","SOURCE_REVEAL_STYLE":"","SYMBOL_NAME":"guest/welcome","SYMBOL_DEFINITION":"","REVISION":"","REFERRING_SYMBOLS":[],"LOCKED_BY_USER":"","INIT_TEXT":false,"RECENT_SYMBOLS":["undefined/undefined","eco_war","brexit_facts","test4","welcome"],"BOTS":{},"INIT_VARS":{},"USER":null,"EXPANSION_HTML":"<i>...bracing...</i>","INITIAL_WARNING":""}
    
//var testSymDef = "[epsilon_5=>the illusion of choice leads back to [[Delta 4]]]\n[delta_4=>Test number &add{four}{$x} &inc$x &link@60,-360{beta}{Indeed, this is #delta_4# so sue me} &reveal{or is it?}{yes, it is.} [[epsilon 5]] #gamma#]\n#delta_4# [[new scene]] ~external_scene [a]@-100,100{[b]{c}}";
